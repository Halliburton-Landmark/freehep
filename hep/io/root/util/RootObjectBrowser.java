 ...
 * @version $Id: RootObjectBrowser.java,v 1.18 2005/08/10 00:56:35 tonyj Exp $
 */
public class RootObjectBrowser extends JPanel implements TreeSelectionListener
{
   private final static String aboutMessage = "<HTML>RootObjectBrowser $Id: RootObjectBrowser.java,v 1.18 2005/08/10 00:56:35 tonyj Exp $<br>Author: Tony Johnson (tonyj@slac.stanford.edu)";
