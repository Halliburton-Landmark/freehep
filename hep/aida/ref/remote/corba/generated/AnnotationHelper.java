...
abstract public class AnnotationHelper
{
  private static String  _id = "IDL:hep/aida/ref/remote/corba/generated/Annotation:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      __typeCode = hep.aida.ref.remote.corba.generated.AnnotationItemHelper.type ();
      __typeCode = org.omg.CORBA.ORB.init ().create_sequence_tc (0, __typeCode);
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (hep.aida.ref.remote.corba.generated.AnnotationHelper.id (), "Annotation", __typeCode);
    }
    return __typeCode;
  }
  ...
  {
    hep.aida.ref.remote.corba.generated.AnnotationItem value[] = null;
    int _len0 = istream.read_long ();
    value = new hep.aida.ref.remote.corba.generated.AnnotationItem[_len0];
    for (int _o1 = 0;_o1 < value.length; ++_o1)
      value[_o1] = hep.aida.ref.remote.corba.generated.AnnotationItemHelper.read (istream);
    return value;
  }
  ...
  public static void write (org.omg.CORBA.portable.OutputStream ostream, hep.aida.ref.remote.corba.generated.AnnotationItem[] value)
  {
    ...
    for (int _i0 = 0;_i0 < value.length; ++_i0)
      hep.aida.ref.remote.corba.generated.AnnotationItemHelper.write (ostream, value[_i0]);
  }
