 ...
 *
 * @author tonyj
 * @version $Id: TestRDataPointSet.java,v 1.7 2005/06/16 20:10:35 chuli Exp $
 */
public class TestRDataPointSet extends RAIDATestCase {
	...
	public void uptPntForDataPntSet(IDataPointSet ps){
		...
		System.out.println("uptPntForDataPontSet.scaleErr = " + scaleErr);
		System.out.println("uptPntForDataPontSet.scaleVal = " + scaleVal);
		...
		switch(dimension){
			...
			case 3:
				...
				break;
			default:
				System.out.println("uptPntForDataPntSet.dimension = " + dimension);
				break;
		}
	}
