 ...
 * @version $Id: Histogram3D.java,v 1.21 2005/10/31 23:58:28 serbo Exp $
 *
 */
...
public class Histogram3D extends Histogram implements IHistogram3D {
    ...
    public void add(IHistogram3D hist) throws IllegalArgumentException {
        ...
        if (! zAxis().equals( hist.zAxis() ) ) throw new IllegalArgumentException("Cannot add. Incompatible histogram binning!");
