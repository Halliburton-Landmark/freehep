...
/**
 * Is a copy of Main, from ANT, but with a public Constructor and runBuild.
 * Modifications are signalled by: //*** MODS ***
 *
 * @author Mark Donszelmann
 * @version $Id: FreeHepMain.java,v 1.4 2004/01/15 19:16:54 duns Exp $
 */
public class FreeHepMain implements AntMain {
...
// renamed Main in FreeHepMain
//*** MODS ***
        FreeHepMain m = new FreeHepMain();
...
//*** MODS ***
     ...
     *
     */
// renamed Main in FreeHepMain and made it public, removed deprecated
//*** MODS ***
    public FreeHepMain(String[] args) throws BuildException {
        processArgs(args);
    }
     ...
     */
// made runBuild public
//*** MODS ***
    public void runBuild(ClassLoader coreLoader) throws BuildException {
