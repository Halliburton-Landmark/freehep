 ...
 * @version $Id: Standard.java,v 1.8 2004/01/19 21:23:55 duns Exp $
 */
...
public class Standard {
    ...
    protected void startGeneration(RootDoc root) {
        ...
        if(!configuration.quiet) {
            System.out.println(  //MD
                "FreeHEP's "+    //MD
                configuration.standardmessage.getText("stddoclet.version", BUILD_DATE) + "\n"); //MD
    ...
    protected void generateClassCycle(ClassDoc[] arr, ClassTree classtree) {
        ...
        for(int i = 0; i < arr.length; i++) {
            ...
            String baseurl = configuration.baseurl; //MD
            ClassWriter.generate(configuration, //MD
                                 curr, prev, next, classtree, //MD
				 baseurl); //MD
        }
    }
