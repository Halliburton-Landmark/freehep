 ...
 * @version $Id: ClassWriter.java,v 1.5 2004/01/15 19:16:58 duns Exp $
 */
...
public class ClassWriter extends SubWriterHolderWriter {
    ...
    public static void generate(ConfigurationStandard configuration,
        ...
        try {
            clsgen = new ClassWriter(configuration,
                                     ...
                                     prev, next, classtree);
            clsgen.generateClassFile(srcURL);       //MD
     ...
     */
    public void generateClassFile(String srcURL) { //MD
        ...
        if(srcURL != null){ //MD
           String classname = classdoc.toString(); //MD
           classname = classname.replace('.', '/');  //MD
           classname = classname.concat(".java");  //MD
           srcURL = srcURL.concat("/" + classname);  //MD
        }
        ...
        if(!configuration.nocomment) {
            ...
            generateTagInfo(classdoc, srcURL);      //MD);
            hr();
            p();
        } else {
            hr();
