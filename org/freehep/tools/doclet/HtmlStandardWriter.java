 ...
 * @version $Id: HtmlStandardWriter.java,v 1.8 2004/01/19 21:23:54 duns Exp $
 */
...
public class HtmlStandardWriter extends HtmlDocWriter {
    ...
    //MD added convenience
    public void generateTagInfo(Doc doc) {     //MD
        generateTagInfo(doc, null); //MD
    } //MD

    /**
     * Print tag information
     */
    public void generateTagInfo(Doc doc, String path) {     //MD
        ...
        if (found
            ...
            if(path != null){ //MD maybe should check if doc.isClass()
               dt(); //MD
               boldText("doclet.Source_Code"); //MD
               dd();//MD
               printHyperLink(path, doc.name() + ".java"); //MD
               ddEnd(); //MD
            } //MD
            dlEnd();
        }
