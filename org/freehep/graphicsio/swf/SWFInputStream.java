 ...
 * @version $Id: SWFInputStream.java,v 1.6 2005/02/28 06:55:58 duns Exp $
 */
public class SWFInputStream extends TaggedInputStream implements SWFConstants {
    ...
    public SWFInputStream(InputStream is, SWFSpriteTagSet tagSet, SWFActionSet actionSet)
        throws IOException {
    ...
    protected TagHeader readTagHeader() throws IOException {
        ...
        if (length==0x3f) length = readUnsignedInt();
