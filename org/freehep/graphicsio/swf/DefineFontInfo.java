 ...
 * @version $Id: DefineFontInfo.java,v 1.4 2003/04/25 23:12:51 duns Exp $
 */
public class DefineFontInfo
    ...
    public DefineFontInfo(int fontID, String name,
    ...
    public SWFTag read(int tagID, SWFInputStream swf, int len)
        ...
        tag.codes = (tag.wideCodes) ? swf.readUnsignedShort(numGlyphs)
                                    : swf.readUnsignedByte(numGlyphs);
        return tag;
    }
