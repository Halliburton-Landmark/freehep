 ...
 * @version $Id: SWFGraphics2D.java,v 1.26 2005/01/05 20:44:41 duns Exp $
 */
public class SWFGraphics2D
    extends AbstractVectorGraphicsIO implements SWFConstants {
    ...
    public final static String version = "$Revision: 1.26 $";
    ...
    protected void writeString(String string, double x, double y) throws IOException {
        ...
        DefineText2.RecordType1 record1 =
            new DefineText2.RecordType1(fontID, textColor, (int)(x*TWIPS), (int)(y*TWIPS),
                        (int)(font.getSize2D()*TWIPS));
...
//                float advance = glyphs.getGlyphMetrics(i).getAdvance();
    ...
    protected void writeClip(Shape s) throws IOException {
        ...
        unwrittenClip = s;
        clipTransform = (unwrittenClip != null) ? new AffineTransform(getTransform()) : null;
    ...
    protected void writePaint(TexturePaint p) throws IOException {
        ...
        fillStyles = new FillStyleArray();
        fillStyles.add(new FillStyle(imageID, true,
                                     new AffineTransform(sx*TWIPS, 0,
                                                         0,        sy*TWIPS,
                                                         a.getX(), a.getY())));
    ...
    SWFShape createShape(Shape shape, int stroke, int fill0, int fill1) throws IOException {
        ...
        double resolution = 0.5/(TWIPS*Math.min(t.getScaleX(), t.getScaleY()));
    ...
    private void popStreamAndWriteClip() throws IOException {
        ...
        os.writeTag(new PlaceObject2(clipID, clipDepthID, clipTransform, clipDepth));

//        System.out.println("Clip "+clipID+" at depth "+clipDepthID+" for clipDepth "+clipDepth+": "+unwrittenClip);
        ...
        if (showClip) {
            ...
            os.writeTag(new PlaceObject(showClipID, showClipDepthID, clipTransform));
        }
