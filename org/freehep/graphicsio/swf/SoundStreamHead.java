 ...
 * @version $Id: SoundStreamHead.java,v 1.4 2003/04/16 05:58:26 duns Exp $
 */
public class SoundStreamHead
    ...
    protected void read(SWFInputStream swf, int len)
        throws IOException {
        ...
        if (streamSoundCompression == 2) latencySeek = swf.readShort();
    }
    ...
    protected void write(SWFOutputStream swf) throws IOException {
        ...
        if (streamSoundCompression == 2) swf.writeShort(latencySeek);
    }
