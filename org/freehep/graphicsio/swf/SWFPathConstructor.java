 ...
 * @version $Id: SWFPathConstructor.java,v 1.7 2004/12/30 07:41:36 duns Exp $
 */
public class SWFPathConstructor extends CubicToQuadPathConstructor implements SWFConstants {
    ...
    public SWFPathConstructor(Vector path, int stroke, int fill0, int fill1, double resolution) {
        super(resolution);
        this.path = path;
        this.stroke = stroke;
        this.fill0 = fill0;
