 ...
 * @version $Id: SWFOutputStream.java,v 1.9 2004/12/22 19:36:05 duns Exp $
 */
public class SWFOutputStream extends TaggedOutputStream implements SWFConstants {
    ...
    public SWFOutputStream(OutputStream os, Dimension size, float frameRate, boolean compress)
        throws IOException {
    ...
    public SWFOutputStream(OutputStream os, SWFTagSet tagSet, SWFActionSet actionSet,
                           Dimension size, float frameRate, boolean compress)
        throws IOException {
    ...
    public void writeRect(Rectangle2D rect, int nbits)
        throws IOException {
    ...
    public void writeColor(Color color, boolean alpha)
        throws IOException {
        ...
        if (alpha) writeUnsignedByte(color.getAlpha());
    }

    public void writeMatrix(AffineTransform matrix)
        throws IOException {

        if (matrix == null) matrix = identityMatrix;
