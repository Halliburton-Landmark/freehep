 ...
 * @version $Id: DefineMorphShape.java,v 1.2 2002/07/30 19:11:32 duns Exp $
 */
public class DefineMorphShape
    ...
    public DefineMorphShape(int id, Rectangle2D startBounds, Rectangle2D endBounds,
                            FillStyleArray fillStyles, LineStyleArray lineStyles,
                            SWFShape startEdges, SWFShape endEdges) {
        this();
        character = id;
