 ...
 * @version $Id: PDF.java,v 1.2 2005/03/11 05:29:10 duns Exp $
 */
public class PDF {
    ...
    private Vector xrefsByNumber = new Vector();        // of offsets stored by refnumber
    ...
    protected void trailer(String rootName, String docInfoName) throws IOException {
        ...
        if (docInfoName != null) dictionary.entry("Info", ref(docInfoName));
        dictionary.close();
