 ...
 * @version $Id: CGMOutputStream.java,v 1.5 2003/11/26 17:39:40 duns Exp $
 */
public class CGMOutputStream extends TaggedOutputStream {
    ...
    public CGMOutputStream(OutputStream os, int version)
        throws IOException {
    ...
    public void writeColorIndex(int i) throws IOException {
        switch(colorIndexPrecision) {
            case 8: writeByte(i); break;
            case 16: writeShort(i); break;
            default:
            case 24: // FIXME
            case 32: writeInt(i); break;
        }
    }
...
//        writeColorComponent(0);  // Don't do this until color model support is provided, RGB is default
    }
    ...
    public void writeVDC(double d) throws IOException {
        if (vdcReal) {
            ...
            switch(vdcIntegerPrecision) {
                default:
                case 16: writeShort((int)d); break;
                case 24: // FIXME
                case 32: writeInt((int)d); break;
            }
        }
    }
    ...
    public void writeName(int name) throws IOException {
        switch(namePrecision) {
            case 8:  writeByte(name); break;
            default:
            case 16: writeShort((int)name); break;
            case 24: // FIXME
            case 32: writeInt((int)name); break;
        }
    }
