...
/**
 * CGM Clear Text Writer. Tags written with this Writer will
 * produce a clear text CGM file. The class also holds the state
 * for the various precisions, defaults, etc...
 *
 * @author Mark Donszelmann
 * @author Charles Loomis
 * @version $Id: CGMWriter.java,v 1.5 2003/05/14 18:29:03 duns Exp $
 */
public class CGMWriter extends IndentPrintWriter implements TaggedOutput {
     ...
     */
    public CGMWriter(Writer writer, int version)
        throws IOException {
    ...
    public void writeColorIndex(int i) throws IOException {
        switch(colorIndexPrecision) {
            case 8: print(Math.max(0, Math.min(255,i))); break;
            case 16: print(Math.max(0, Math.min(65535,i))); break;
            default:
            case 24: // FIXME
            case 32: print(i); break;
        }
    }
    ...
    public void writeColorComponent(int c) throws IOException {
        switch(directColorPrecision) {
            default:
            case 8:  print(Math.max(0, Math.min(255,c))); break;
            case 16: print(Math.max(0, Math.min(65535,c))); break;
            case 24: // FIXME
            case 32: print(c); break;
        }
    }
    ...
    public void writeInteger(int i) throws IOException {
        switch(integerPrecision) {
            case 8:  print((byte)i); break;
            default:
            case 16: print((short)i); break;
            case 24: // FIXME
            case 32: print(i); break;
        }
    }
    ...
    public void writeVDC(double d) throws IOException {
        if (vdcReal) {
            ...
            switch(vdcIntegerPrecision) {
                default:
                case 16: print((short)d); break;
                case 24: // FIXME
                case 32: print(d); break;
            }
        }
    }
    ...
    public void writeName(int name) throws IOException {
        switch(namePrecision) {
            case 8:  print(Math.max(0, Math.min(255,name))); break;
            default:
            case 16: print(Math.max(0, Math.min(65535,name))); break;
            case 24: // FIXME
            case 32: print(name); break;
        }
    }
