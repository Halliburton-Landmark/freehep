 ...
 * @version $Id: MetafileElementList.java,v 1.2 2002/01/23 11:09:43 duns Exp $
 */
public class MetafileElementList
    ...
    public void write(int tagID, CGMWriter cgm) throws IOException {
        ...
        switch(set) {
            default:
            case DRAWING_SET:               cgm.writeString("DRAWINGSET"); break;
            case DRAWING_PLUS_SET:          cgm.writeString("DRAWINGPLUS"); break;
            case VERSION_2_SET:             cgm.writeString("VERSION2"); break;
            case EXTENDED_PRIMITIVES_SET:   cgm.writeString("EXTDPRIM"); break;
            case VERSION_2_GKSM_SET:        cgm.writeString("VERSION2GKSM"); break;
            case VERSION_3_SET:             cgm.writeString("VERSION3"); break;
            case VERSION_4_SET:             cgm.writeString("VERSION4"); break;
        }
    }
}
