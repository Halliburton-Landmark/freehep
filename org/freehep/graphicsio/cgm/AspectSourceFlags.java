 ...
 * @version $Id: AspectSourceFlags.java,v 1.1 2001/11/29 01:45:24 duns Exp $
 */
public class AspectSourceFlags
    ...
    public void write(int tagID, CGMWriter cgm) throws IOException {
        ...
        for (int i=0; i<asfType.length; i++) {
            switch(asfType[i]) {
                default:
                case LINE_TYPE:                     cgm.print("LINETYPE"); break;
                case LINE_WIDTH:                    cgm.print("LINEWIDTH"); break;
                case LINE_COLOR:                    cgm.print("LINECOLR"); break;
                case MARKER_TYPE:                   cgm.print("MARKERTYPE"); break;
                case MARKER_SIZE:                   cgm.print("MARKERSIZE"); break;
                case MARKER_COLOR:                  cgm.print("MARKERCOLR"); break;
                case TEXT_FONT_INDEX:               cgm.print("TEXTFONTINDEX"); break;
                case TEXT_PRECISION:                cgm.print("TEXTPREC"); break;
                case CHARACTER_EXPANSION_FACTOR:    cgm.print("CHAREXPAN"); break;
                case CHARACTER_SPACING:             cgm.print("CHARSPACE"); break;
                case TEXT_COLOR:                    cgm.print("TEXTCOLR"); break;
                case INTERIOR_STYLE:                cgm.print("INTSTYLE"); break;
                case FILL_COLOR:                    cgm.print("FILLCOLR"); break;
                case HATCH_INDEX:                   cgm.print("HATCHINDEX"); break;
                case PATTERN_INDEX:                 cgm.print("PATINDEX"); break;
                case EDGE_TYPE:                     cgm.print("EDGETYPE"); break;
                case EDGE_WIDTH:                    cgm.print("EDGEWIDTH"); break;
                case EDGE_COLOR:                    cgm.print("EDGECOLR"); break;
            }
            cgm.print(", ");
            switch(asfValue[i]) {
                default:
                case INDIVIDUAL: cgm.print("INDIV"); break;
                case BUNDLED:    cgm.print("BUNDLED"); break; 
            }
            cgm.println();
        }
        cgm.outdent();
