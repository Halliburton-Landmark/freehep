 ...
 * @version $Id: CellArray.java,v 1.2 2003/09/29 23:51:58 duns Exp $
 */
public class CellArray extends CGMTag {
    ...
    private CellArray(Point2D p, Point2D q, Point2D r,
                     Color[][] colorArray, int precision, int mode) {
        this();
        this.p = p;
        this.q = q;
        this.r = r;
     ...
     */
    public CellArray(Point2D p, Point2D q, Point2D r,
                     Color[][] colorArray) {
