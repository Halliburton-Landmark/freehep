 ...
 *==========================
 * recursive quadratic approximation with adjustable tolerance
 *
 * March 4, 2004
 *
 * Robert Penner
 * www.robertpenner.com/tools/bezier_cubic.zip
 * file: bezier_draw_cubic.as 
 *==========================
 *
 * @author Mark Donszelmann
 * @version $Id: CubicToQuadPathConstructor.java,v 1.7 2004/12/28 18:02:44 duns Exp $
 */
public abstract class CubicToQuadPathConstructor extends AbstractPathConstructor {
    ...
    static class Test extends CubicToQuadPathConstructor {
        ...
        public void quad(double x1, double y1, double x2, double y2) {
            System.out.println("Quad: ("+currentX+", "+currentY+") ("+x1+", "+y1+") ("+x2+", "+y2+")");
            currentX = x2;
            currentY = y2;
        }
