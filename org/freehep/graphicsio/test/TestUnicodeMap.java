 ...
 * @version $Id: TestUnicodeMap.java,v 1.4 2004/01/16 23:05:07 duns Exp $
 */
    ...
    class TestPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
            if (g!=null) {
                ...
                int ix = dw/2+dw;
                for (int i=0; i<16; i++) {
                    vg.drawString(label[i],
                                  dw/2, iy,
                                  VectorGraphics.TEXT_CENTER,
                                  VectorGraphics.TEXT_CENTER,
                                  false, Color.cyan, 2, false, Color.yellow);
                    vg.drawString(label[i],
                                  ix, dh/2,
                                  VectorGraphics.TEXT_CENTER,
                                  VectorGraphics.TEXT_CENTER,
                ...
                iy = dh/2+dh;
                ix = dw/2;
                for (int i=(int) startString.charAt(0);
                     i<=(int) endString.charAt(0);
                     i++) {
                    ...
                    vg.drawString(character.toString(),
                                  ix, iy,
                                  VectorGraphics.TEXT_CENTER,
                                  VectorGraphics.TEXT_CENTER,
                                  false, Color.cyan, 2, true, Color.yellow);
                    iy+= dh;
                }
