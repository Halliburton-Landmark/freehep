 ...
 * </code></pre>
 * where <code>originalGraphics</code> is the original
 * <code>Graphics2D</code> object.  Note that <code>dispose</code>
 * must be called when the drawing finishes on
 * <code>tempGraphics</code> and that no drawing should be done on
 * <code>originalGraphics</code> until <code>dispose</code> has been
 * called.
 *
 * @author Charles Loomis
 * @author Mark Donszelmann
 * @version $Id: VectorGraphics.java,v 1.31 2004/07/13 22:39:47 duns Exp $
 */
 ...
 */
    ...
    public abstract void fillAndDrawSymbol(double x, double y,
                                           double size, int symbol, 
                                           Color fillColor);
    /**
     * Draws a string.
