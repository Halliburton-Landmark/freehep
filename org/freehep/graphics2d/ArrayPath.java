 ...
 *  @version $Id: ArrayPath.java,v 1.2 2004/04/02 22:27:05 duns Exp $
 */
public class ArrayPath implements Shape {
    ...
    public PathIterator getPathIterator(AffineTransform t) {
        ...
        return new ArrayPathIterator(transformedXPoints, transformedYPoints, nPoints, closed, resolution);
    }
}
