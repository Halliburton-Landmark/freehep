 ...
 * @version $Id: PrintColor.java,v 1.5 2003/05/15 23:26:23 duns Exp $
 */
public class PrintColor extends Color {
    ...
    private static void testColorValueRange(float asGray) {
    	...
    	if ( rangeError == true ) {
        	throw new IllegalArgumentException("PrintColor parameter outside of expected range:"
        					   + badComponentString);
    	}
    }
    ...
    public PrintColor getColor(int mode) {
        ...
        switch (mode) {
            ...
            default: throw new IllegalArgumentException("ColorMode on PrintColor out of range: "+mode);
        }
    }
