 ...
 * @author  tonyj
 * @version $Id: SAXTraverser.java,v 1.4 2002/07/20 00:43:58 tonyj Exp $
 */
public class SAXTraverser extends DefaultHandler
{
   ...
   protected void handleSubElement(SAXTraverser sub) throws SAXException
   {
    ...
    /**
     * Override this to handle the start of new sub elements
     * Return the SAXTraverser to be used for the sub node, or <code>this</code> to continue
