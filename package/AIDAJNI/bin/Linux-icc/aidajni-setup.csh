...
if (! -e "${AIDAJNI_HOME}/lib/Linux-icc/libAIDAJNI.a") then
...
setenv PATH "${AIDAJNI_HOME}/bin/Linux-icc:${PATH}"
if (! $?CLASSPATH) then
   setenv CLASSPATH ""
endif
...
setenv LD_LIBRARY_PATH "${AIDAJNI_HOME}/lib/Linux-icc:${LD_LIBRARY_PATH}"
...
setenv AIDAJNI_LIBS "-L${AIDAJNI_HOME}/lib/Linux-icc -lAIDAJNI -lFHJNI -L${JDK_HOME}/jre/lib/i386/client -ljvm"
