...
if ! test -e "${AIDAJNI_HOME}/lib/Linux-icc/libAIDAJNI.a"
then
...
export PATH="${AIDAJNI_HOME}/bin/Linux-icc:${PATH}"
export CLASSPATH="${AIDAJNI_HOME}/lib/freehep-aidajni.jar:${CLASSPATH}"

export LD_LIBRARY_PATH="${AIDAJNI_HOME}/lib/Linux-icc:${LD_LIBRARY_PATH}"
...
export AIDAJNI_LIBS="-L${AIDAJNI_HOME}/lib/Linux-icc -lAIDAJNI -lFHJNI -L${JDK_HOME}/jre/lib/i386/client -ljvm"
