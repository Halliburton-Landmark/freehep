...
if (! -e "${AIDAJNI_HOME}/lib/Linux-g++/libAIDAJNI.a") then
...
setenv PATH "${AIDAJNI_HOME}/bin/Linux-g++:${PATH}"
if (! $?CLASSPATH) then
   setenv CLASSPATH ""
endif
...
setenv LD_LIBRARY_PATH "${AIDAJNI_HOME}/lib/Linux-g++:${LD_LIBRARY_PATH}"
...
setenv AIDAJNI_LIBS "-L${AIDAJNI_HOME}/lib/Linux-g++ -lAIDAJNI -lFHJNI -L${JDK_HOME}/jre/lib/i386/client -ljvm"
