...
if (! -e "${HEPREP_HOME}/lib/Linux-g++/libHEPREP.a") then
   echo "The libHEPREP.a file seem to be missing, make sure HEPREP_HOME has been set properly"
   exit
endif

setenv PATH "${HEPREP_HOME}/bin/Linux-g++:${PATH}"

if (! $?LD_LIBRARY_PATH) then
   setenv LD_LIBRARY_PATH ""
endif
setenv LD_LIBRARY_PATH "${HEPREP_HOME}/lib/Linux-g++:${LD_LIBRARY_PATH}"

setenv HEPREP_INCLUDES -I${HEPREP_HOME}/include
setenv HEPREP_LIBS "-L${HEPREP_HOME}/lib/Linux-g++ -lHEPREP -lZIPIOS -lZLIB"
